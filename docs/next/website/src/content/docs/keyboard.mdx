...
In navigate mode, use `up` / `down` to move the highlighted workspace or agent row, `1..9` to jump by index, and `Enter` to open the highlighted workspace or focus the highlighted agent.
